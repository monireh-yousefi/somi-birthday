...
const xPos = [0, 100, 200, 0, 100, 200, 0, 100, 200];
const yPos = [0, 0, 0, 100, 100, 100, 200, 200, 200];
...
function updateTileImage(tile) {
  let b = parseInt(tile.innerHTML);

  if (b != numberOfTiles) {
    tile.style.backgroundImage = "url(images/puzzle_image.jpg)";
    tile.style.backgroundPositionX = -xPos[b - 1].toString() + "px";
    tile.style.backgroundPositionY = -yPos[b - 1].toString() + "px";
  } else {
